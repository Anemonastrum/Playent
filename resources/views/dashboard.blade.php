...
<div id="sidebar" class="bg-light sticky-top">
    ...
    <ul class="flex-column d-block list-group w-100 align-items-center justify-content-center">
        <a href="{{ route('dashboard') }}" class="list-group-item list-group-item-action sidebar-item active"><i class="fas fa-home fa-fw me-4"></i>Dashboard</a>
...
<div id="content" class="content-t flex-grow-1 p-4">
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        {{ __('You are logged in for the first time!') }}
    </div>
    @endif
        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-header">
                    <div class="fw-bold">Nama Rental</div>
                </div>
                <div class="card-body">
                    <h3>Kecap Playstation</h3>
                </div>
            </div>
        </div>
        <div class="col-md-6">
