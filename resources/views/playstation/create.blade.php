...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">Add PlayStation</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('playstation.store') }}">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary mt-3">Add PlayStation</button>
                        </div>
                    </form>
                </div>
            </div>
