                ...
                @foreach($rentals as $rental)
                    <div class="col">
                        <div class="card h-100">
                            <div class="card-body">
                                <h5 class="card-title">Bilik #{{ $loop->iteration }}</h5>
                                <p class="card-text">Pelanggan: {{ $rental->customer_name }}</p>
                                <p class="card-text">Kontak: {{ $rental->contact_number }}</p>
                                {{-- <p class="card-text">Durasi: {{ $rental->rental_duration }} Jam</p> --}}
                            </div>
                            <div class="card-footer d-flex justify-content-center">
                                <a href="{{ route('rental.edit', $rental->id) }}" class="btn btn-primary me-2">Edit</a>
